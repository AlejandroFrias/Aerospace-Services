...
class BathroomsControllerTest < ActionController::TestCase
  ...
  test "should create bathroom" do
    assert_difference('Bathroom.count') do
      post :create, bathroom: { altitude: @bathroom.altitude, building: @bathroom.building, floor: @bathroom.floor, latitude: @bathroom.latitude, longitude: @bathroom.longitude, type: @bathroom.type }
    end
  ...
  test "should update bathroom" do
    patch :update, id: @bathroom, bathroom: { altitude: @bathroom.altitude, building: @bathroom.building, floor: @bathroom.floor, latitude: @bathroom.latitude, longitude: @bathroom.longitude, type: @bathroom.type }
    assert_redirected_to bathroom_path(assigns(:bathroom))
  end
